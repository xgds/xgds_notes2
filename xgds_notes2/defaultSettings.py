...
XGDS_MAP_SERVER_JS_MAP[XGDS_NOTES_MODEL_NAME] = {'ol': 'xgds_notes2/js/olNoteMap.js',
                                                   ...
                                                   'order_columns': ['pk', 'event_time', 'event_timezone',
                                                                     'author__first_name', 'content', 'tags'],
...
XGDS_MAP_SERVER_JS_MAP[XGDS_NOTES_MESSAGE_MODEL_NAME] = {'ol': 'xgds_notes2/js/olMessageMap.js',
                                                   ...
                                                   'columnWidths': ['15px', '100px', '20px', '100px', 'auto'],
...
XGDS_SSE_NOTE_MESSAGE_CHANNELS = []
XGDS_NOTES_CURRENT_MAPPED_FUNCTION = 'xgds_notes.views.defaultCurrentMapNotes'

XGDS_NOTES_MAP_NOTE_CHANNEL = 'map_note'
XGDS_NOTES_NOTE_SSE_TYPE = XGDS_NOTES_MODEL_NAME
XGDS_NOTES_MESSAGE_SSE_TYPE = XGDS_NOTES_MESSAGE_MODEL_NAME
